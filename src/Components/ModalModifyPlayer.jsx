...
const ModalModifyPlayer = ({ players, setCurrentItem, setPlayers, currentItem, initialRef, isOpenModal1, onOpenModal1, onCloseModal1 }) => {
    //Chakra Toast
    const toast = useToast()


    //Modif Player Function
    const handleModif = (e, player_id) => {
        e.preventDefault()
        onCloseModal1();
        const newList = players.filter(res => res.player_id !== player_id)
